...
class ULCRewardsCfg:
    ...
    feet_force = RewTerm(
        ...
        weight=-0.01,
        params={"threshold": 300.0, "sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*ankle_roll.*")},
    )
...
class ULCRobotPlayEnvCfg(ULCRobotEnvCfg):
    def __post_init__(self):
        ...
        self.commands.ulc_command.fixed_command = (0.0, 0.0, 0.0, 0.76, 0.0, 0.0, 0.0) + (0.0,) * 14
