...
def ulc_curriculum_ranges(
    ...
    torso_yaw_abs: float = 2.62,
    torso_roll_abs: float = 0.52,
    ...
    return {
        "height": (
            (default_height - 0.03) + ah * (root_height_range[0] - (default_height - 0.03)),
            (default_height + 0.03) + ah * (root_height_range[1] - (default_height + 0.03)),
        ),
        "torso_yaw": (-au * torso_yaw_abs, au * torso_yaw_abs),
        "torso_roll": (-au * torso_roll_abs, au * torso_roll_abs),
